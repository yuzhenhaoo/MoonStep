...
import com.example.administrator.moonstep.Utils.TitleNamesUtils;
    ...
    public void initView(){
        ...
        (view.findViewById(R.id.click_collpase)).setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(is_collapse){
                    is_collapse = false;
                    view.findViewById(R.id.click_collpase).setBackgroundResource(R.mipmap.collapse_logo);
                }else{
                    is_collapse = true;
                    view.findViewById(R.id.click_collpase).setBackgroundResource(R.mipmap.open_logo);
                }
