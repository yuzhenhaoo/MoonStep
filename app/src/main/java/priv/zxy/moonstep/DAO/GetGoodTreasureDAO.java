 ...
 */
public class GetGoodTreasureDAO {
    private static GetGoodTreasureDAO instance = null;

    private static final String GOOD_TREASURE = "treasure";

    private static final String URL = UrlBase.GOOD_TREASURE;

    public static GetGoodTreasureDAO getInstance() {
        if (instance == null) {
            instance = new GetGoodTreasureDAO();
        }
        return instance;
    }
        ...
        AndroidNetworking.post(URL)
                ...
                .getAsJSONArray(new JSONArrayRequestListener() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        Gson gson = new Gson();
                        LinkedList<Good> goods = gson.fromJson(response.toString(), listType);
