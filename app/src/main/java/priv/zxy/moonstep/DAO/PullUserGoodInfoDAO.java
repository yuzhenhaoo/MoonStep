...
public class PullUserGoodInfoDAO {

    private static final String TAG = "PullUserGoodInfoDAO";
    private static final String GOOD_TAG = "good";

    private static PullUserGoodInfoDAO instance;

    public static PullUserGoodInfoDAO getInstance() {
        if (instance == null){
            synchronized (PullUserGoodInfoDAO.class){
                if (instance == null){
                    instance = new PullUserGoodInfoDAO();
                }
            }
        }
        return instance;
    ...
    public void getUserGood(CallBack callBack, String phoneNumber){
        ...
        RequestBody formBody = new FormBody.Builder()
                .add(DaoConstant.PHONE_NUMBER, phoneNumber)
                .build();
