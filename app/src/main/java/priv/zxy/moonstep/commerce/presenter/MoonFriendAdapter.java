...
public class MoonFriendAdapter extends RecyclerView.Adapter<MoonFriendAdapter.MyHolder> {
    ...
    private MoonFriendAdapter.OnItemClickListener mOnItemClickListener;
...
//        intent.putExtra("headPortrait", item.getHeadPortrait());//暂时还不知道Bitmap怎么通过Activity进行传输
    ...
    public MoonFriendAdapter.OnItemClickListener getOnItemClickListener() {
        return mOnItemClickListener;
    }

    void setOnItemClickListener(MoonFriendAdapter.OnItemClickListener onItemClickListener) {
